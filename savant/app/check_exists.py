...
def shadow_exists(username, password, lastchanged, minmium, maximum, warn, inactive, expire, reserve):
	return spcalls.spcall('shadow_exists', (username, password, lastchanged, minmium, maximum, warn, inactive, expire, reserve,), True)
...
def shadow2_exists(username, password, lastchanged, minmium, maximum, warn, inactive, expire, reserve):
	return spcalls.spcall('shadow2_exists', (username, password, lastchanged, minmium, maximum, warn, inactive, expire, reserve,), True)
