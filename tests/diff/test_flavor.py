...
import lib.flavor.obj

@pytest.fixture(scope='function')
def type_missing():
    return lib.diff.flavor.Flavor({})
...
@pytest.fixture(scope='function')
def type_mismatch():
    return lib.diff.flavor.Flavor({}, 1)
...
@pytest.fixture(scope='function')
def only_in():
    flavor1 = lib.flavor.obj.Obj()
    flavor1.record_system('a', {})
    flavor2 = lib.flavor.obj.Obj()
    flavor2.record_system('b', {})
    return lib.diff.flavor.Flavor(flavor1, flavor2)
